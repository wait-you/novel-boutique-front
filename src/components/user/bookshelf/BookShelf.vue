<template>
  <div class="my_r">
    <div class="my_bookshelf">
      <div class="title cf">
        <h2 class="fl"><router-link class="red" :to="{name: 'bookshelf_list'}">我的书架</router-link></h2>
        <i class="fl ml20 mr20 font16">|</i>
        <h2 class="fl"><router-link :to="{name: 'read_history'}">最近阅读</router-link></h2>
      </div>
...
import {getUserinfo, updateUserInfo, listFeedback, listBookShelf} from "@/api/user";
