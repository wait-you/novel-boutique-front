<template>
  <div class="my_l">
    <ul class="log_list">
      <li>
        <router-link class="link_4" active-class="on" :to="{name: 'authorBookList'}">小说管理</router-link>
        <router-link class="link_4" active-class="on" :to="{ name: 'authorIncome' }">稿费收入</router-link>
      </li>
    </ul>
  </div>
</template>
