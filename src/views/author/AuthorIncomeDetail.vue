    ...
    <div class="my_bookshelf">
      ...
      <div id="divData" class="updateTable">
        <table cellpadding="0" cellspacing="0">
          ...
          <tbody id="bookList">
            <tr class="book_list" v-for="item in authorIncomeDetails">
              <td class="goread">
                {{item.incomeDate}}
              </td>
              <td class="goread">
...
import {incomeDaily, listBooks} from "@/api/author";
...
export default {
  ...
  setup() {
    ...
    const load = async () => {
      const {data} = await incomeDaily(state.page, state.limit);
      state.authorIncomeDetails = data.list;
